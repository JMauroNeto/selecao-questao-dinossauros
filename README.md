...
```
Abaixo você terá as informações necessárias para a resolução do teste, sendo:
...
g = 9,8 m / s ^ 2 (constante gravitacional)
    ...
    Escreva um programa para ler os arquivos e imprimir apenas os nomes dos dinossauros bípedes do mais rápido ao mais lento. Não imprima qualquer outra informação.
